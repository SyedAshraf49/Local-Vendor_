...
export const VegetableMedleyIcon: React.FC<{ className?: string }> = ({ className }) => ( // for Vegetables
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.3,6.7a3,3,0,0,1-4.2,4.2L5.5,16.5,4,15l5.6-5.6a3,3,0,0,1,4.2-4.2l.5.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.8,11.2,10,14l-1.5-1.5L10,10Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.5,11a5.5,5.5,0,1,1-7.8,0,5.5,5.5,0,0,1,7.8,0Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.65,7.15A5.5,5.5,0,0,0,10.7,5.3" />
  </svg>
);

export const AppleIcon: React.FC<{ className?: string }> = ({ className }) => ( // for Fruits
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12,2A7,7,0,0,0,5,9c0,5.25,7,13,7,13s7-7.75,7-13A7,7,0,0,0,12,2Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12,2a4,4,0,0,1,4,4c0,2-1,3-2,3.5" />
  </svg>
);

export const MilkCartonIcon: React.FC<{ className?: string }> = ({ className }) => ( // for Dairy
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8,21V8.5L12,3l4,5.5V21H8Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8,8.5h8" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5,12h3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5,15.5h3" />
  </svg>
);

export const ChocolateWrapperIcon: React.FC<{ className?: string }> = ({ className }) => ( // for Chocolates
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.8,13.4l-4.2-4.2,3.4-3.4,4.2,4.2Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.8,14.2,12,16l-1.8-1.8,1.8-1.8" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.8,12.2,2,14l7.8,7.8,1.8-1.8Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.8,21.8,14.6,17" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.8,13.4,14.6,17" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M22.2,9.2,18,5,16.2,6.8" />
  </svg>
);

export const NewspaperStackIcon: React.FC<{ className?: string }> = ({ className }) => ( // for Newspapers
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.5,17.5V5.5a1,1,0,0,1,1-1h15a1,1,0,0,1,1,1v12a1,1,0,0,1-1,1h-15a1,1,0,0,1-1-1Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.5,16.5h17" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.5,9.5h7" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.5,12.5h7" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.5,16V4a1,1,0,0,0-1-1h-15a1,1,0,0,0-1,1v1" />
  </svg>
);
